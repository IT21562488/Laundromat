...
<body>
    ...
    <div class="main">
        ...
        <div class="card">
            <div class="card-head">View Customer</div>
        ...
        <div class="card">
            <form class="viewEmp" name="form" action="ViewCus" method="post"   onsubmit="return validate()">
            ...
            <div class="card-body">
                     ...
                     <br><br>
                        <div>
                            <label for="inputFirstName">Enter Customer ID</label><br>
                            <input id="id" type="text" name="id" placeholder=" Enter Customer ID" />
            ...
            <!-- Save changes button-->
            <br>
            <button class="button" type="submit" name="submit" >View Customer </button>
             </div>
            <br><br>
        </form>
        </div>
