...
<a href = "admin.jsp"><button type="button" class="btn btn-secondary btn btn-primary">Package Selectors</button></a>
 <a href = "adminpayments.jsp"><button type="button" class="btn btn-secondary btn btn-primary">Payment and Loyalty</button></a>
...
List<PackageSelectors> list=PackageSelectDao.getAllRecords();  
request.setAttribute("list",list);  

%>  
<section>
  <!--for demo wrap-->
  <h1>Package Selectors</h1>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      ...
      <c:forEach items="${list}" var="u">
        ...
        <td>${u.getMobile()}</td>
        <td>${u.getStatus()}</td>
        <td><form  method="post" action="UpdateStatusServlet">
        <input type="text" name="number" hidden="hidden" value=${u.getNumber()}>
        <input type="text" name="status" hidden="hidden" value=${u.getStatus()}><input type ="submit" class="btn btn-primary btn-sm" role="button" value = "Edit Status"></form></td>
        </tr>
         </c:forEach>
      </tbody>
    </table>
...
<form method="post" action="SearchPackageServlet">
...
<section>
  <!--for demo wrap-->
  <h1>Searched Package Selectors</h1>
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
